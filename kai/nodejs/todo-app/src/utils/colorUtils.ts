...
export const COLOR_TOKENS: ColorMap = {
  red: {
    ...
    cssVar: '--pf-t--global--danger-color--100',
    label: 'Red',
    background: '#c9190b'
  },
  orange: {
    token: 'global_warning_color_100',
    cssVar: '--pf-t--global--warning-color--100',
    label: 'Orange',
    background: '#f0ab00'
  },
  blue: {
    token: 'global_info_color_100',
    cssVar: '--pf-t--global--info-color--100',
    label: 'Blue',
    background: '#2b9af3'
  },
  green: {
    token: 'global_success_color_100',
    cssVar: '--pf-t--global--success-color--100',
    label: 'Green',
    background: '#3e8635'
  },
  purple: {
    token: 'global_purple_100',
    cssVar: '--pf-t--global--purple--100',
    label: 'Purple',
    background: '#6753ac'
  },
  gray: {
