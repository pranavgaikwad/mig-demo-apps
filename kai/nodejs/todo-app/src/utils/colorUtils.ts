...
export const COLOR_TOKENS: ColorMap = {
  red: {
    ...
    cssVar: "--pf-t--global--icon--color--status--danger--default",
    label: 'Red',
    background: '#c9190b'
  },
  orange: {
    token: 'global_warning_color_100',
    cssVar: "--pf-t--global--icon--color--status--warning--default",
    label: 'Orange',
    background: '#f0ab00'
  },
  blue: {
    token: 'global_info_color_100',
    cssVar: "--pf-t--global--icon--color--status--info--default",
    label: 'Blue',
    background: '#2b9af3'
  },
  green: {
    token: 'global_success_color_100',
    cssVar: "--pf-t--global--icon--color--status--success--default",
    label: 'Green',
    background: '#3e8635'
  },
  purple: {
    token: 'global_purple_100',
    cssVar: '--pf-t--global--icon--color--status--custom--default',
    label: 'Purple',
    background: '#6753ac'
  },
  gray: {
